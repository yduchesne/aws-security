#!/usr/bin/env bash
# Source this script before operating the Identity Center Terraform root.
...
_identity_center_main() {
  ...
  printf 'Validated Identity Center prerequisites: landing zone is ACTIVE and IN_SYNC.\n'
}
