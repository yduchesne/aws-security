...
The configuration is in `terraform/lab/week2/exercise13/`. It has an
...
cp terraform/lab/week2/exercise13/.env.example \
  terraform/lab/week2/exercise13/.env
...
terraform -chdir=terraform/lab/week2/exercise13 fmt -check
...
terraform -chdir=terraform/lab/week2/exercise13 output
```
...
1. Open **IAM** and inspect the exercise role under `/week2/exercise13/`.
