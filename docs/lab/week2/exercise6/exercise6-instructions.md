...
The configuration is in `terraform/lab/week2/exercise6/`. It has an
...
cp terraform/lab/week2/exercise6/.env.example \
  terraform/lab/week2/exercise6/.env
...
terraform -chdir=terraform/lab/week2/exercise6 fmt -check
...
terraform -chdir=terraform/lab/week2/exercise6 output
```
