...
The configuration is in `terraform/lab/week2/exercise9/`. It has an
...
cp terraform/lab/week2/exercise9/.env.example \
  terraform/lab/week2/exercise9/.env
...
terraform -chdir=terraform/lab/week2/exercise9 fmt -check
...
terraform -chdir=terraform/lab/week2/exercise9 output
```
