...
The configuration is in `terraform/lab/week2/exercise11/`. It has an
...
cp terraform/lab/week2/exercise11/.env.example \
  terraform/lab/week2/exercise11/.env
...
terraform -chdir=terraform/lab/week2/exercise11 fmt -check
...
terraform -chdir=terraform/lab/week2/exercise11 output
```
...
1. Open **IAM** and inspect the exercise role under `/week2/exercise11/`.
