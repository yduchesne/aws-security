...
The configuration is in `terraform/lab/week2/exercise4/`. It has an
...
cp terraform/lab/week2/exercise4/.env.example \
  terraform/lab/week2/exercise4/.env
...
terraform -chdir=terraform/lab/week2/exercise4 fmt -check
...
terraform -chdir=terraform/lab/week2/exercise4 output
```
