# Week 2 Exercise 4 [Optional] — Permissions boundaries versus AdministratorAccess
...
This exercise focuses on **permissions ceilings**. Its objective is to prove AdministratorAccess is limited by a boundary. An Allow
...
The exercise state owns only resources under `/week2/exercise4/` and the
...
For the exercise-specific policy, inspect [`main.tf`](../../../../terraform/lab/week2/exercise4/main.tf) before applying and record
...
trust policy and the complete declaration in [`main.tf`](../../../../terraform/lab/week2/exercise4/main.tf).
...
echo "role_arn: $(terraform -chdir=terraform/lab/week2/exercise4 output -raw role_arn)"
```
...
For Exercise 4, the central comparison is: **Prove administratoraccess is limited by a boundary.** Do
...
1. Open **IAM** and inspect the exercise role under `/week2/exercise4/`.
