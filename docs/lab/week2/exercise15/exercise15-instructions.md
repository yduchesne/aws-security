...
The configuration is in `terraform/lab/week2/exercise15/`. It has an
...
cp terraform/lab/week2/exercise15/.env.example \
  terraform/lab/week2/exercise15/.env
...
terraform -chdir=terraform/lab/week2/exercise15 fmt -check
...
terraform -chdir=terraform/lab/week2/exercise15 output
```
