...
The configuration is in `terraform/lab/week2/exercise5/`. It has an
...
cp terraform/lab/week2/exercise5/.env.example \
  terraform/lab/week2/exercise5/.env
...
terraform -chdir=terraform/lab/week2/exercise5 fmt -check
...
terraform -chdir=terraform/lab/week2/exercise5 output
```
