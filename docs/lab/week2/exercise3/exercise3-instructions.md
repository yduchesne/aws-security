...
The configuration is in `terraform/lab/week2/exercise3/`. It has an
...
cp terraform/lab/week2/exercise3/.env.example \
  terraform/lab/week2/exercise3/.env
...
terraform -chdir=terraform/lab/week2/exercise3 fmt -check
...
terraform -chdir=terraform/lab/week2/exercise3 output
```
