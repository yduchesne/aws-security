...
The configuration is in `terraform/lab/week2/exercise10/`. It has an
...
cp terraform/lab/week2/exercise10/.env.example \
  terraform/lab/week2/exercise10/.env
...
terraform -chdir=terraform/lab/week2/exercise10 fmt -check
...
terraform -chdir=terraform/lab/week2/exercise10 output
```
