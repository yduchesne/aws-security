...
The configuration is in `terraform/lab/week2/exercise8/`. It has an
...
cp terraform/lab/week2/exercise8/.env.example \
  terraform/lab/week2/exercise8/.env
...
terraform -chdir=terraform/lab/week2/exercise8 fmt -check
...
terraform -chdir=terraform/lab/week2/exercise8 output
```
