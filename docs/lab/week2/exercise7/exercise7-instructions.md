...
The configuration is in `terraform/lab/week2/exercise7/`. It has an
...
cp terraform/lab/week2/exercise7/.env.example \
  terraform/lab/week2/exercise7/.env
...
terraform -chdir=terraform/lab/week2/exercise7 fmt -check
...
terraform -chdir=terraform/lab/week2/exercise7 output
```
