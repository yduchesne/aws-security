...
The exercise state owns only resources under `/week2/exercise7/` and the
...
For the exercise-specific policy, inspect [`main.tf`](../../../../terraform/lab/week2/exercise7/main.tf) before applying and record
...
trust policy and the complete declaration in [`main.tf`](../../../../terraform/lab/week2/exercise7/main.tf).
...
echo "role_arn: $(terraform -chdir=terraform/lab/week2/exercise7 output -raw role_arn)"
```
...
For Exercise 7, the central comparison is: **Require both project and environment attributes to match.** Do
...
1. Open **IAM** and inspect the exercise role under `/week2/exercise7/`.
